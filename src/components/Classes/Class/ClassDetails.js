      ...
      <div className={styles.class}>
        <Container fluid>
          <div className={styles.header}>
            ...
            <div className={styles["title"]}>{course.course_id}: {course.course_name}</div>
                  ...
                  <ul>
                    ...
                    <Accordion>
                      <Accordion.Item eventKey="0" className="materials">
                        <Accordion.Header>View Course Materials</Accordion.Header>
                        <Accordion.Body>
                          {el.materials.map((el) => {
                            return (
                              <div className={styles['material-item']} key={el.title}>
                                <span>{el.title}</span>
                                <span>
                                  <a href={el.view} target="_blank" rel="noreferrer" className="btn btn-primary" style={{marginRight: '10px'}}>View</a>
                                  <a href={el.download} className="btn btn-primary">Download</a>
                                </span>
                              </div>
                            )
                          })}
                      ...
                      <Accordion.Item eventKey="1" className="materials">
                        <Accordion.Header>View Created Quizzes</Accordion.Header>
                        <Accordion.Body>
                          <div>
                            <a href="/quizzes" className="w-100 mb-3 btn btn-primary">
                              Create Quiz
                            </a>
                          </div>
                          <div>
